...
def enc(params, kw, PK_S, SK_A, PK_A, PK_B):
    ...
    temp = params['P'] * (PK_B_1**group.hash((kw, lambda_1, lambda_2), ZR))
    Q = temp**r 
...
def TrapGen(params, kw, PK_S, PK_A, SK_B):
    ...
    tr = group.serialize(group.hash((kw, lambda_1_ast, lambda_2_ast), ZR)*SK_B_1)
    return tr
